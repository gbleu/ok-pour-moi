...
OK Pour Moi stores the following data **locally on your device only** using Chrome's storage API:

1. **Signature Image:** Your signature image (PNG or JPG format) uploaded for signing PDFs
...
All processing happens locally on your device. Your signature image and configuration never leave your computer.
...
1. **`storage`**
   - **Purpose:** Save your signature image and configuration settings locally on your device
   - **Scope:** Local device storage only, not synced to cloud
...
4. **`downloads`**
   - **Purpose:** Download PDF attachments for signing and save signed PDFs
   - **Scope:** Only triggered when you explicitly use the sign feature

5. **Host Permissions** (outlook.office365.com, outlook.office.com, outlook.live.com, attachments.office.net)
